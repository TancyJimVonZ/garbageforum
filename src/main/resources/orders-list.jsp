...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<!-- 页面头部 -->
		<jsp:include page="../../../forum-web/src/main/webapp/pages/header.jsp"></jsp:include>
		<!-- 页面头部 /-->
		<!-- 导航侧栏 -->
		<jsp:include page="../../../forum-web/src/main/webapp/pages/aside.jsp"></jsp:include>
		<!-- 导航侧栏 /-->
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='user-add.jsp'">
